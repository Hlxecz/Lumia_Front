    ...
    try {
      ...
      if (typeof data === 'string') {
          ...
          if (errData.message) {
              ...
              errMsg = '게시글 수정 중 오류가 발생했습니다.';
          }
      } else {
          errMsg = '게시글 수정 중 알 수 없는 오류가 발생했습니다.';
      }
      Alert.alert(`수정 실패`, errMsg);
      // ======================= ▲▲▲ 수정된 부분 ▲▲▲ =======================
    } finally {
...
const styles = StyleSheet.create({
  ...
  scrollContentContainer: { flexGrow: 1, paddingHorizontal: 20, paddingBottom: 100 },
  ...
  input: { borderWidth: 1, borderColor: '#CBD5E0', borderRadius: 8, backgroundColor: '#fff', paddingHorizontal: 15, paddingVertical: 12, fontSize: 16, color: '#2D3748' },
  textArea: { minHeight: 150, textAlignVertical: 'top' },
  fab: { position: 'absolute', right: 24, bottom: Platform.OS === 'ios' ? 90 : 24, width: 60, height: 60, borderRadius: 30, backgroundColor: '#3B82F6', justifyContent: 'center', alignItems: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5 },
